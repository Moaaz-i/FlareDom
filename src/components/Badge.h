...
public:
    Badge(const String &l, const String &v = "info")
        : label(l), variant(v) {}
    ...
    static String css() {
        return
            ...
            ".flare-badge-warning{background:rgba(245,158,11,0.15);color:#fbbf24;}"
            ".flare-badge-danger{background:rgba(239,68,68,0.15);color:#f87171;}"
            ".flare-badge-neutral{background:rgba(255,255,255,0.08);color:#94a3b8;}";
    }
};
