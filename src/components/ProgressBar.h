...
public:
  ProgressBar(int v, const String &var = "primary") : value(v), variant(var) {
    barId = IDGen::next("pb");
  }
  ...
  Element render() override {
    ...
    if (showLabel) {
      ...
      header.addChild(Element::create("span")
  ...
  static String css() {
    return ".flare-progress-wrapper{margin:12px 0;}"
           ...
           "}"
           ".flare-progress-primary{background:linear-gradient(90deg,#3b82f6,#"
           "60a5fa);}"
           ".flare-progress-success{background:linear-gradient(90deg,#22c55e,#"
           "4ade80);}"
           ".flare-progress-danger{background:linear-gradient(90deg,#ef4444,#"
           "f87171);}"
           ".flare-progress-warning{background:linear-gradient(90deg,#f59e0b,#"
           "fbbf24);}";
  }
};
